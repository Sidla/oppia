...
describe('expression interpolation service', () => {
  ...
  it('should correctly interpolate and escape HTML strings', () => {
    ...
    expect(
      expressionInterpolationService.processHtml('abc{{a}}', [
        {
          a: 'b',
        },
      ])
    ...
    expect(
      expressionInterpolationService.processHtml('abc{{a{{b}}}}', [
        {
          a: '1',
          b: '2',
        },
  ...
  it('should correctly interpolate unicode strings', () => {
    expect(expressionInterpolationService.processUnicode('abc', [{}])).toEqual(
      'abc'
    );
    expect(
      expressionInterpolationService.processUnicode('abc{{a}}', [
        {
          a: 'b',
        },
      ])
    ...
    expect(
      expressionInterpolationService.processUnicode('abc{{a+b}}', [
        {
          a: '1',
          b: '2',
        },
  ...
  it('should correctly get params from strings', () => {
    expect(expressionInterpolationService.getParamsFromString('abc')).toEqual(
      []
    );
    expect(
      expressionInterpolationService.getParamsFromString('abc{{a}}')
    ).toEqual(['a']);
    expect(
